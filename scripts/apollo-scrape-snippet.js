...
//    the last expression returns the JSON. Write the result to
//    scripts/data/apollo-scrape-<date>.json.
// 2. Human: paste the whole file into the DevTools console on the Apollo tab.
//    It logs the JSON and downloads apollo-scrape-<date>.json - drop that file
//    into scripts/data/.
//
